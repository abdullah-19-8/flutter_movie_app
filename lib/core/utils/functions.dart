...
Widget getSimilarSection(List<Media>? similar, BuildContext context) {
  ...
  if (similar != null && similar.isNotEmpty) {
    return Column(
      ...
      children: [
        SectionTitle(title: localize.similar),
        SectionListView(
          height: AppSize.s240,
...
Widget getOverviewSection(String overview, BuildContext context) {
  AppLocalizations localize = AppLocalizations.of(context)!;
  ...
  if (overview.isNotEmpty) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        SectionTitle(title: localize.story),
